...
class Sewa extends Component {
    ...
    handleChange(event) {
        this.setState({ sewa: event.target.sewa });
    }
                ...
                <div className="card mt-2">
                    ...
                    <div className="card-body">
                                ...
                                {this.state.sewa.map((item, index) => {
                                    return (
                                        <tr key={item.id_sewa} >
                                            ...
                                            <td>{item.biaya}</td>
                                            <td>
                                                <button className="m-1 btn btn-sm btn-info" onClick={() => this.Accept(item.id_sewa)}>
                                                    <span className="fa fa-check-circle"></span> Accept
                                                </button>
                                                <button className="m-1 btn btn-sm btn-danger" onClick={() => this.Decline(item.id_sewa)}>
                        ...
                        <Modal id="modal_sewa" title="Form Sewa" bg_header="success" text_header="white">
                            ...
                            <button onClick={() => console.log(this.state)} className="btn btn-info btn-block">
                                    <span className="fa fa-check"></span> Cek Data
                            </button>
                        </Modal>
